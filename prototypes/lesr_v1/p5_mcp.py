"""P5 MCP adapter. Only this module imports the replaceable MCP SDK."""
...
def create_server(domain: LESRDomainPort) -> FastMCP:
    server = FastMCP("LESR v1 Prototype")

    @server.tool()
    def capabilities() -> dict[str, Any]:
        """Negotiate the versioned LESR domain capability groups."""
        return {
            "domain_contract": "1.0-prototype",
...
def main() -> None:
    create_server(PrototypeDomainService()).run()
