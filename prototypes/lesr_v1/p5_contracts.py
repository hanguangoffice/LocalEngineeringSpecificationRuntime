"""P5 domain capability contract with no dependency on an MCP SDK."""
...
from prototypes.lesr_v1.p1_semantic import uuid7_candidate
...
class CapabilityDescriptor:
    ...
    contract_version: str = "1.0-prototype"
...
class PrototypeDomainService:
    """Deterministic in-memory port used only to validate adapter contracts."""
