    ...
    sorted(
        (
            ...
            for name, access, mcp, task in (
                ...
                ("context.read", CapabilityAccess.READ, True, False),
                ("context.trace", CapabilityAccess.READ, True, True),
                ("workspace.inspect", CapabilityAccess.READ, True, False),
                ("repository.health", CapabilityAccess.READ, True, False),
                ("workspace.open", CapabilityAccess.WRITE, True, False),
                ("workspace.edit", CapabilityAccess.WRITE, True, False),
                ("workspace.checkpoint", CapabilityAccess.WRITE, True, False),
                ("workspace.validate", CapabilityAccess.WRITE, True, True),
                ("workspace.submit", CapabilityAccess.WRITE, True, False),
                ("workspace.rebase", CapabilityAccess.WRITE, True, False),
                ("workspace.merge", CapabilityAccess.WRITE, True, False),
                ("workspace.resolve", CapabilityAccess.WRITE, True, False),
                ("review.comment", CapabilityAccess.WRITE, True, False),
                ("review.resolve", CapabilityAccess.WRITE, True, False),
                ("apply", CapabilityAccess.WRITE, True, False),
                ("baseline.prepare", CapabilityAccess.WRITE, True, True),
                ("baseline.apply", CapabilityAccess.WRITE, True, False),
                ("reconciliation", CapabilityAccess.WRITE, True, False),
